module gitlab.com/contextualcode/go-object-store/examples
...
require (
	...
	gitlab.com/contextualcode/go-object-store/http v0.0.1
	gitlab.com/contextualcode/go-object-store/store v0.0.1
)
...
require (
	...
	gitlab.com/contextualcode/go-object-store/types v0.0.1 // indirect
